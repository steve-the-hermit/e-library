      ...
      <div className='Home'>
        <div className='text-container'>
          <p className='text'>"I would tell anyone to just sign up without reservation. I now have more books"
            <p className='textname'>by: Drake Ntimama</p>
          </p>
          <p className='text'>"Without hesitation, I'd recommend anyone to join; my book collection now exceeds"
            <p className='textname'>by: Steve Macharia</p>
          </p>
          <p className='text'>"I actually download several books a week... I would say I’ve saved a lot with BookHub."
            <p className='textname'>by: Richard Kimani</p>
          </p>
          <p className='text'>"There are series I would have never discovered if it weren’t for BookHub."
            <p className='textname'>by: Collins Wakahenya</p>
          </p>
        </div>
      </div>
    </div>
